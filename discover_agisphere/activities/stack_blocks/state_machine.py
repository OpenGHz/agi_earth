...
"""
Script to run an environment with a stack blocks state machine.
...
parser = argparse.ArgumentParser(description="Stack blocks state machine for lift environments.")
